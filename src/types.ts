...
export type Problem = { id: string; title: string; slug: string; difficulty: string; category: string; tags: string[]; url: string; content: string; contentFormat?: string; templates: Record<Language,string>; available?: boolean; meta?: any; source?: { url?:string; verifiedAt?:string; contentUrl?:string; contentLanguage?:string; contentMethod?:string; translation?: {kind:string; translatedAt:string; originalLanguage:string; originalSha256:string}; method?:string }; };
